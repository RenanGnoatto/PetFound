        ...
        btAtualizarPet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ivFotoPetEdit.getDrawable() != null &&
                        ...
                        db.execSQL("update pet set nome = '" + edtNomePetEdit +
                    ...
                    edtNomePetEdit.setText("");
                    sCidadePetEdit.setId(0);
                    edtDetalhesPetEdit.setText("");
                    edtDetalhesSumicoEdit.setText("");
                    ivFotoPetEdit.setImageDrawable(null);
                }
                else {
/*                    Snackbar sbCadastroRealizado = Snackbar.make(findViewById(R.id.CoordinatorLayoutPetEdit),"É necessário informar uma Foto, Nome, cidade e detalhes do seu Pet!",Snackbar.LENGTH_SHORT);
    ...
    public void carregaDados(int idPet){
        ...
        while (cur.moveToNext()) {
            ...
            sCidadePetEdit.setId(cur.getInt(2));
